...
namespace ProjetoFinalAna.Controllers
{
    public class ColaboradorController : Controller
    {
        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            if(pesquisa== null)
            {
                var contexto = _context.Colaborador.OrderBy(x => x.ColaboradorNome).Include(c => c.Cidade).Include(c => c.TipoColaborador);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.Set<TipoColaborador>(), "Id", "TipoColaboradorNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ColaboradorNome,ColaboradorCpf,ColaboradorSexo,ColaboradorTelefone,CidadeId,TipoColaboradorId")] Colaborador colaborador)
        {
            ...
            ViewData["TipoColaboradorId"] = new SelectList(_context.Set<TipoColaborador>(), "Id", "TipoColaboradorNome", colaborador.TipoColaboradorId);
            return View(colaborador);
        }
