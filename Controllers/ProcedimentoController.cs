...
namespace ProjetoFinalAna.Controllers
{
    public class ProcedimentoController : Controller
    {
        ...
        public async Task<IActionResult> Index(string pesquisa)
        {
            if(pesquisa == null)
            {
                var contexto = _context.Procedimento.OrderBy(x => x.ProcedimentoNome).Include(p => p.TipoProcedimento);
            ...
            else
            {
                ...
                .Where(x => x.ProcedimentoNome.Contains(pesquisa));
                return View(await contexto.ToListAsync());
            }
        ...
        {
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "Id", "TipoProcedimentoNome");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProcedimentoNome,ProcedimentoObservacao,TipoProcedimentoId")] Procedimento procedimento)
        {
            ...
            ViewData["TipoProcedimentoId"] = new SelectList(_context.Set<TipoProcedimento>(), "Id", "TipoProcedimentoNome", procedimento.TipoProcedimentoId);
            return View(procedimento);
        }
